...
const ChecklistPhotoFront: React.FC<{ reportNo: any; modelNo: String }> = (
  props
) => {
  const {
    register,
    ...
    axios
      .post(
        "http://" +
          ...
          "/api/checklistphoto/?photo=front&reportNo=" +
          props.reportNo +
          "&modelNo=" +
          props.modelNo,
        formData
    ...
    <IonGrid className="photo">
      ...
      {photoValue && (
        <>
          <input
            type="hidden"
            {...register("frontviewphotoid")}
            value={imageRes}
          />
          <input
            type="hidden"
            {...register("frontviewphotofilename")}
            value={imageFilename}
          />
        </>
      )}
...
export default ChecklistPhotoFront;
