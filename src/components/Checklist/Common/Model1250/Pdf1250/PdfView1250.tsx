...
import Header1250 from "./Header1250";
import Chracteristics1250 from "./Chracteristics1250";
import ReportHeaderRow1250 from "./ReportHeaderRow1250";
    ...
    <PDFViewer width="100%" height="800">
      <Document>
        <Page size="A4" style={styles.page} wrap={true}>
          <Header1250 />
          <ReportHeaderRow1250 items={resultsDetail} />
          <Chracteristics1250 results={resultsDetail} />
        </Page>
      </Document>
    </PDFViewer>
  );
