...
const ChecklistPhotoMain1250: React.FC<{ reportSrNo: String }> = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IonRow>
          <ChecklistPhotoFront reportNo={props.reportSrNo} modelNo="1250" />
        </IonRow>
      </IonGrid>
      <IonGrid
        style={{
      ...
      >
        ...
        <IonRow>
          ...
          <ChecklistPhotoSide reportNo={props.reportSrNo} modelNo="1250" />
        </IonRow>
      </IonGrid>
      <IonGrid
        style={{
      ...
      >
        ...
        <IonRow>
          {/* <ChecklistPhoto uploadUrl="?photo=sideview" /> */}
          <ChecklistPhotoOne reportNo={props.reportSrNo} modelNo="1250" />
        </IonRow>
      </IonGrid>
      <IonGrid
        style={{
      ...
      >
        ...
        <IonRow>
          {/* <ChecklistPhoto uploadUrl="?photo=sideview" /> */}
          <ChecklistPhotoTwo reportNo={props.reportSrNo} modelNo="1250" />
        </IonRow>
      </IonGrid>
    </IonGrid>
  );
...
export default ChecklistPhotoMain1250;
