...
const NewCharacteristics_500Details: React.FC<{
    ...
    <IonRow className="ion-padding">
      <table>
        <tbody>
          ...
          <tr>
            <td>14</td>
            <td>Center To Center Distance Between Adjacent Cap</td>
            <td>297-303/397-4003</td>
            <td>
              <IonInput
                type="text"
...
export default NewCharacteristics_500Details;
