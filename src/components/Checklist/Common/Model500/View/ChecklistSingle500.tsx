...
const ChecklistSingle500 = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "http://" + process.env.REACT_APP_URL + "/api/checklist500/" + lastPath
      )
      .then((res) => {
        // console.log(res);
    ...
    <IonGrid style={{ margin: "10px" }}>
      <table style={{ paddingTop: "10px" }}>
        <caption className="ion-padding">
          <h2>
            <strong>Pre-Despatch Inspection Checklist 500KVA</strong>
          </h2>
        </caption>
        <tbody>
          <tr>
      ...
      <div style={{ paddingTop: "15px" }}>
        <table>
          <tbody>
            ...
            <tr>
              <td>33</td>
              <td>Slot Elevation from panel Side at Horizontal angle</td>
              <td>
                290 <sup>±3</sup> / 75 <sup>±2</sup>
              </td>
              <td>{checklist.actualresult_29}</td>
            </tr>
            <tr>
              <td>34</td>
              <td>Slot Size at Horizontal angle</td>
              <td>10 ±2 x 20 ±2</td>
              <td>{checklist.actualresult_29}</td>
            </tr>
            <tr>
              <td>35</td>
              <td>Distance of Hole on Support Column</td>
              <td>730 ±3 / 60 ±2</td>
              <td>{checklist.actualresult_29}</td>
            </tr>
            <tr>
              <td>36</td>
              <td>Size & Qty of Holes Hole on Support Column.</td>
              <td>Φ14 / 2</td>
              <td>{checklist.actualresult_29}</td>
            </tr>
          </tbody>
...
export default ChecklistSingle500;
