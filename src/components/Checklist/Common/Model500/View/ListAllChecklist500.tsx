...
const ListAllChecklist500 = () => {
  ...
  const onDeleteHandle = (ev: number) => {
          ...
          handler: () => {
            ...
            axios
              ...
              .then((res) => {
                ...
                history.push("/list-checklist/500");
              })
              .catch((err) => {
                errorAlert({
                  header: "Error!",
    ...
    axios
      .delete("http://" + process.env.REACT_APP_URL + "/api/checklist500/" + ev)
      ...
      <IonList>
        {checklists.map((result, index) => (
          <IonItem key={index}>
            ...
            <IonButton routerLink={`${"/checklist/500/edit/" + result._id}`}>
              Edit
            </IonButton>
            <IonButton routerLink={`${"/checklist/500/view/" + result._id}`}>
              View
            </IonButton>
...
export default ListAllChecklist500;
