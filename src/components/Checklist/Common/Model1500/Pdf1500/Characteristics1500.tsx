  ...
  return (
    <View>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>2136-2144</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>1081-1089</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>1581-1589</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>847-853</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>1024.5-1032.5</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>1/4 Inch NPT 5 Places</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>297-303/397-403</Text>
      ...
      <View style={styles.row}>
        <Text style={styles.serialnumber}></Text>
        <Text style={styles.characteristics}>
          HTA COOLER(Model No.GC-026X26)
        </Text>
        <Text style={styles.dimension}></Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>287-293 / 73-77</Text>
        <Text style={styles.actualresult}>{results.actualresult_32}</Text>
        <Text style={styles.classification}>M2</Text>
        <Text style={styles.equipmenttobeused}>Measuring Tape</Text>
        <Text style={styles.remarks}>Accepted</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>8-12 x 18-22</Text>
        <Text style={styles.actualresult}>{results.actualresult_32}</Text>
        <Text style={styles.classification}>M2</Text>
        <Text style={styles.equipmenttobeused}>Measuring Tape</Text>
        <Text style={styles.remarks}>Accepted</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>727-733 ±3 / 58-62</Text>
        <Text style={styles.actualresult}>{results.actualresult_32}</Text>
        <Text style={styles.classification}>M2</Text>
        <Text style={styles.equipmenttobeused}>Measuring Tape</Text>
        <Text style={styles.remarks}>Accepted</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.dimension}>Φ14/2</Text>
        <Text style={styles.actualresult}>{results.actualresult_32}</Text>
        <Text style={styles.classification}>M2</Text>
        <Text style={styles.equipmenttobeused}>Measuring Tape</Text>
        <Text style={styles.remarks}>Accepted</Text>
