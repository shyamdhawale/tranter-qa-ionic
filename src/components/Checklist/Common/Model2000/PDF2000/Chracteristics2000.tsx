...
const Chracteristics2000: React.FC<props> = ({ results }) => {
  return (
    <View style={{ paddingTop: "10px" }}>
      ...
      >
        <Text>Pre Despatch Inspection Report2000</Text>
      </View>
      ...
      <View style={styles.mainView}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>2176-2184</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>1051-1059</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>1676-1684</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>1496-1504</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>527-533</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>413-419</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>162-166</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>797-803</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>367-373</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>2319-325</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>747-753</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>4</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>152-158/ 248-252</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>8 Nos./Dia.14X34</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>115-120</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>OD 100/190.5/4</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.characteristics}>Pack Length</Text>
          <Text style={styles.dimensionreq}>231-237</Text>
        ...
        <View style={styles.row}>
          <Text style={styles.srno}></Text>
          <Text style={styles.characteristics}>
            FUAL COOLER(Model No.GC-008X32)
          </Text>
          <Text style={styles.dimensionreq}></Text>
          <Text style={styles.actualresult}></Text>
        </View>
        <View style={styles.row}>
          ...
          <Text style={styles.characteristics}>Pack Length</Text>
          <Text style={styles.dimensionreq}>80-83</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>640</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.dimensionreq}>60</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.characteristics}>Nozzle Size/PCD/Qty No.</Text>
          <Text style={styles.dimensionreq}>1.0''BSP SOCKET/4No.</Text>
