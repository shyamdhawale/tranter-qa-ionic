...
const ChecklistPhotoMain2000: React.FC<{ reportSrNo: String }> = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IonRow>
          <ChecklistPhotoFront reportNo={props.reportSrNo} modelNo="2000" />
        </IonRow>
      </IonGrid>
      <IonGrid
        style={{
      ...
      >
        ...
        <IonRow>
          ...
          <ChecklistPhotoSide reportNo={props.reportSrNo} modelNo="2000" />
        </IonRow>
      </IonGrid>
      <IonGrid
        style={{
      ...
      >
        ...
        <IonRow>
          {/* <ChecklistPhoto uploadUrl="?photo=sideview" /> */}
          <ChecklistPhotoOne reportNo={props.reportSrNo} modelNo="2000" />
        </IonRow>
      </IonGrid>
      <IonGrid
        style={{
      ...
      >
        ...
        <IonRow>
          {/* <ChecklistPhoto uploadUrl="?photo=sideview" /> */}
          <ChecklistPhotoTwo reportNo={props.reportSrNo} modelNo="2000" />
        </IonRow>
      </IonGrid>
    </IonGrid>
  );
...
export default ChecklistPhotoMain2000;
